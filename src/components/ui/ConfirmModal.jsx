...
const ConfirmModal = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md rounded-sm overflow-hidden shadow-2xl transition-all scale-100"
      ...
      >
        ...
        {/* Header */}
        <div className="px-6 py-5 border-b border-[#C8B99A]/40">
          <h3
        ...
        {/* Footer actions */}
        <div
          className="px-6 py-4 flex gap-3 border-t border-[#C8B99A]/40"
