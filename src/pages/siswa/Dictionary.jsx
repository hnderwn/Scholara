...
import WordCard, { levelBadgeClass } from '../../components/siswa/WordCard';
...
const Dictionary = () => {
  ...
  return (
    <div className="min-h-screen pb-20" style={{ backgroundColor: '#F2ECD8', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      >
        <RedRule />
        {selectedItem && <WordCard item={selectedItem} relatedItems={relatedItems} onClose={closeDetail} onSelectRelated={selectRelated} langMode={langMode} />}
        <RedRule />
      </aside>
